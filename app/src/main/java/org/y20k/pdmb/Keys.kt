...
object Keys {
    ...
    // application name
    const val APPLICATION_NAME: String = "Pdmb"
    ...
    // intent actions
    const val ACTION_START: String = "org.y20k.pdmb.action.START"
    const val ACTION_STOP: String = "org.y20k.pdmb.action.STOP"
    const val ACTION_RESUME: String = "org.y20k.pdmb.action.RESUME"
