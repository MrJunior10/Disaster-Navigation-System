...
import org.y20k.pdmb.MainActivity
import org.y20k.pdmb.R
import org.y20k.pdmb.TrackerService
    ...
    fun createNotification(trackingState: Int, trackLength: Float, duration: Long, useImperial: Boolean): Notification {
        ...
        when (trackingState) {
            Keys.STATE_TRACKING_ACTIVE -> {
                builder.setContentTitle(trackerService.getString(R.string.notification_title_pdmb_running))
                ...
                builder.setContentTitle(trackerService.getString(R.string.notification_title_pdmb_not_running))
