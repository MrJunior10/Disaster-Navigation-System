...
import org.y20k.pdmb.dialogs.RenameTrackDialog
import org.y20k.pdmb.helpers.FileHelper
import org.y20k.pdmb.helpers.LogHelper
import org.y20k.pdmb.helpers.MapOverlayHelper
import org.y20k.pdmb.helpers.TrackHelper
import org.y20k.pdmb.ui.TrackFragmentLayoutHolder
    ...
    override fun onYesNoDialog(type: Int, dialogResult: Boolean, payload: Int, payloadString: String) {
        when (type) {
            Keys.DIALOG_DELETE_TRACK -> {
                if (dialogResult) {
                    // user tapped remove track - switch to TracklistFragment and remove track there
